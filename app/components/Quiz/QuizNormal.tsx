...
import { QuestionsNormal } from "../../data/Questions";
...
const QuizNormal = ({ navigation }: any) => {
  ...
  const rightAnswer = QuestionsNormal[question].answer === currentAnswer;
  const questionState = QuestionsNormal[question];
